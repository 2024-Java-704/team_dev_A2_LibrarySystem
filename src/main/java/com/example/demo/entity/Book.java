...
public class Book {
	...
	public Book(Integer id,Category category, String title, String hurigana, String author, String publisher, LocalDate pubYear, LocalDate regDay, Condition condition, Library library, Integer cnt,String img) {
		this.id=id;
		this.category=category;
		this.title=title;
		this.hurigana=hurigana;
